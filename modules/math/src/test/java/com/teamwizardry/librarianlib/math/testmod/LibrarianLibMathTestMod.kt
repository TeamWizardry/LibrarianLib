package com.teamwizardry.librarianlib.math.testmod
...
@Mod(LibrarianLibMathTestMod.MODID)
class LibrarianLibMathTestMod {
    init {
...
//            LOGGER.info("HELLO from Register Block")
    ...
    companion object {
        const val MODID: String = "librarianlib-math-testmod"

...
//        main.add(bg)
        ...
        mask1.rotation_rm.animate(0.0, PI * 2, 40f).repeat()
        ...
        mask2.rotation_rm.animate(0.0, PI * 2, 40f).repeat()
        outer2.add(inner2)
    ...
    companion object {
        val spiral: Sprite = Mosaic(Identifier.of("liblib_facade_test:textures/spiral_mask.png"), 128, 128).getSprite("")
    }
}
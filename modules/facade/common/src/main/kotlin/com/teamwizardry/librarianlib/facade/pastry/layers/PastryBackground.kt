...
public class PastryBackground(type: PastryBackgroundStyle, posX: Int, posY: Int, width: Int, height: Int): GuiLayer(posX, posY, width, height) {
    public constructor(posX: Int, posY: Int, width: Int, height: Int): this(PastryBackgroundStyle.VANILLA, posX, posY, width, height)
    public constructor(posX: Int, posY: Int): this(PastryBackgroundStyle.VANILLA, posX, posY, 0, 0)
    public constructor(): this(PastryBackgroundStyle.VANILLA, 0, 0, 0, 0)

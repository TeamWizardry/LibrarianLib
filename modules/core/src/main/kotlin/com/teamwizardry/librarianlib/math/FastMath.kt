...
public fun fastInvSqrt(value: Float): Float = MathHelper.fastInvSqrt(value.toDouble()).toFloat()
public fun fastInvSqrt(value: Double): Double = MathHelper.fastInvSqrt(value)

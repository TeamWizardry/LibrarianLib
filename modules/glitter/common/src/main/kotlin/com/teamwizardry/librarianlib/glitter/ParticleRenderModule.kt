...
public interface ParticleRenderModule {
     ...
     */
    public fun render(context: ParticleRenderContext, particles: List<DoubleArray>, prepModules: List<ParticleUpdateModule>) {}
     ...
     * GL transformation matrix has been set up such that raw world coordinates can be used.
     */
    public fun renderDirect(context: ParticleRenderContext, particles: List<DoubleArray>, prepModules: List<ParticleUpdateModule>) {}
}

public class ParticleRenderContext(
    public val profiler: Profiler,
    public val matrixStack: MatrixStack,

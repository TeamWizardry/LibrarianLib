    ...
    init {
        ...
        this.bind(
            Shader.build("glitter_sprite")
                .vertex(Identifier.of("liblib_glitter:sprite.vert"), *features)
                .geometry(Identifier.of("liblib_glitter:sprite.geom"), *features)
                .fragment(Identifier.of("liblib_glitter:sprite.frag"), *features)
                .build()
        )
    }

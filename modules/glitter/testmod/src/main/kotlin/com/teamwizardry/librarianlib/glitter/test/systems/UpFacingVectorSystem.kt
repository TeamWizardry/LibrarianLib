...
object UpFacingVectorSystem : TestSystem(Identifier.of("liblib_glitter_test:up_facing_vector")) {
    override fun configure() {
        ...
        renderModules.add(
            SpriteRenderModule.build(
                SpriteRenderOptions.build(Identifier.of("liblib_glitter_test:textures/glitter/arrow.png"))
                    .diffuseLight(true)
                    .cull(false)
                    .build(),
                pos,

...
import com.teamwizardry.librarianlib.glitter.test.modules.HeldItemConditionalRenderModule
import net.minecraft.entity.Entity
import net.minecraft.util.Identifier
import net.minecraft.util.math.MathHelper
import net.minecraft.util.math.Vec3d

object PhysicsOnlySystem : TestSystem(Identifier.of("liblib_glitter_test:physics_only")) {
    override fun configure() {
        ...
        renderModules.add(
            HeldItemConditionalRenderModule(
                Identifier.of("liblib_glitter_test:physics_only_entity"),

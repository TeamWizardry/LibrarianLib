...
object DepthSortSystem : TestSystem(Identifier.of("liblib_glitter_test:depth_sort")) {
    override fun configure() {
        ...
        renderModules.add(
            SpriteRenderModule.build(Identifier.of("liblib_glitter_test:textures/glitter/depthsort.png"), pos)

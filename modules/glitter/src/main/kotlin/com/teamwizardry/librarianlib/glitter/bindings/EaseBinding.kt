 ...
 */
public class EaseBinding @JvmOverloads constructor(
    /**
     ...
     * may have.
     */
    @JvmField public val bindingSize: Int,
    /**
     ...
     */
    @JvmField public var target: ReadParticleBinding = ConstantBinding(*DoubleArray(bindingSize) { 1.0 })

 ...
 *
 * While it would be easy to store information about particles in fields as [Vector3d]s, [Color]s, and any number of other
 * objects, doing so is slow and incurs a major memory burden, especially the immutable [Vector3d], which must be
 ...
 * allocating [Vector3d]s and other short-lived objects, as well as the JVM overhead of simply storing those objects.

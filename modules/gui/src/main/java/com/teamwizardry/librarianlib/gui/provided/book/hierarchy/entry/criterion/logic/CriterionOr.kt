package com.teamwizardry.librarianlib.gui.provided.book.hierarchy.entry.criterion.logic
 ...
 */
class CriterionOr(json: JsonObject) : ICriterion {
    ...
    override fun isUnlocked(player: EntityPlayer, grantedInCode: Boolean) =
            criteria.any { it.isUnlocked(player, grantedInCode) }
}

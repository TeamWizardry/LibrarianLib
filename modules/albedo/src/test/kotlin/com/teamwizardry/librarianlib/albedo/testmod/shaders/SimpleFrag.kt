...
object SimpleFrag {
    ...
    fun draw() {
        ...
        buffer.finish()
        SimpleFragShader.unbind()
    }

    private val renderType = SimpleRenderTypes.flat(GL11.GL_QUADS)

    private object SimpleFragShader: Shader("simple_frag", null, ResourceLocation("librarianlib-albedo-test:shaders/simple_frag.frag")) {

...
//            test("simple_frag", )
//            test("primitive_uniform", )
            test("float_uniform", TestFloatUniform)
            test("float_array_uniform", TestFloatArrayUniform)
            test("int_uniform", TestIntUniform)
            test("int_array_uniform", TestIntArrayUniform)
            test("bool_uniform", TestBoolUniform)
            test("bool_array_uniform", TestBoolArrayUniform)
//            test("matrix_uniform", TestMatrixUniform)
//            test("matrix_array_uniform", TestMatrixArrayUniform)
//            test("sampler_uniform", TestSamplerUniform)
//            test("sampler_array_uniform", TestSamplerArrayUniform)
//            test("struct_uniform", TestStructUniform)

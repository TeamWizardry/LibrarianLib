package com.teamwizardry.libarianlib.client.book.pages;
...
import com.teamwizardry.libarianlib.client.Color;
import com.teamwizardry.libarianlib.client.TextureDefinition;
import com.teamwizardry.libarianlib.client.gui.GuiEvent;
import com.teamwizardry.libarianlib.client.gui.components.GuiComponentButton;
import com.teamwizardry.libarianlib.common.data.DataNode;
import com.teamwizardry.libarianlib.common.data.DataNodeParsers;
import com.teamwizardry.libarianlib.math.Matrix4;
import com.teamwizardry.libarianlib.math.Vec2;
import com.teamwizardry.libarianlib.multiblock.Structure;
import com.teamwizardry.libarianlib.multiblock.StructureRenderUtil;
...
public class GuiPageStructure extends GuiPageCommon {
	...
	public GuiPageStructure(GuiScreen parent, DataNode data, DataNode globalData, String mod, String path, int page) {
        ...
        TextureDefinition def = new TextureDefinition(new ResourceLocation(LibrarianLib.MODID, "textures/gui/texturesheet/structure.png"), 128, 128, /*unused ->*/ 0, 0, 128, 128);

...
import com.teamwizardry.libarianlib.client.ScissorUtil;
import com.teamwizardry.libarianlib.client.book.BookHandler;
import com.teamwizardry.libarianlib.client.book.PageRegistry;
import com.teamwizardry.libarianlib.client.book.gui.Tippable;
import com.teamwizardry.libarianlib.client.gui.EnumMouseButton;
import com.teamwizardry.libarianlib.client.gui.GuiComponentContainer;
import com.teamwizardry.libarianlib.client.gui.GuiEvent;
import com.teamwizardry.libarianlib.client.gui.IGuiEventListener;
        ...
        if (button.id == Const.ButtonID.NAV_BAR_INDEX) {
            if (parent == null) {
                ...
                if (!indexPath.equals(path))
                    parent = PageRegistry.construct(null, mod, indexPath, 0); // parent is null because otherwise pressing back goes to the child gui
                if (parent == null) {

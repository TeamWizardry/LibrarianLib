...
import com.teamwizardry.libarianlib.client.book.gui.TextControl;
...
public class GuiPageText extends GuiPageCommon {
    ...
    public GuiPageText(GuiScreen parent, DataNode data, DataNode globalData, String mod, String path, int page) {

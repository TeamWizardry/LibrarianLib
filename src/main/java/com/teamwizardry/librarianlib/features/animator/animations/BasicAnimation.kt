 ...
 */
class BasicAnimation<T : Any> @JvmOverloads constructor(target: T, property: AnimatableProperty<T>, completion: Runnable = Runnable {}) : Animation<T>(target, property, completion) {

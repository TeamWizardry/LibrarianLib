...
/**
 * A basic animation from [from] to [to]. Both values default to the current array of this animation's property
 */
class BasicAnimation<T : Any>(target: T, property: AnimatableProperty<T>) : PropertyAnimation<T>(target, property) {
    ...
    /**
     * The array of the property at [start]
     */
    var from: Any = property.get(target)

    /**
     * The array of the property at [end]
     */

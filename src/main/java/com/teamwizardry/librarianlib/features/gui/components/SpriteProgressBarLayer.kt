...
class SpriteProgressBarLayer @JvmOverloads constructor(
    var sprite: ISprite?, x: Int, y: Int, width: Int = sprite?.width ?: 16, height: Int = sprite?.height ?: 16) : GuiLayer(x, y, width, height) {

    class AnimationLoopEvent(val component: SpriteProgressBarLayer) : Event()

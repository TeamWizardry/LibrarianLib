...
class TextLayer @JvmOverloads constructor(posX: Int, posY: Int, var horizontal: TextLayer.TextAlignH = TextLayer.TextAlignH.LEFT, var vertical: TextLayer.TextAlignV = TextLayer.TextAlignV.TOP) : GuiLayer(posX, posY) {

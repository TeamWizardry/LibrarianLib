 ...
 * All rights reserved.
 */
class ComponentRenderableStructure(x: Int, y: Int, width: Int, height: Int, val structure: RenderableStructure?, subtext: TranslationHolder?) : ComponentStructure(x, y, width, height, subtext) {
...
class ComponentDynamicStructure(x: Int, y: Int, width: Int, height: Int, val structure: ResourceLocation, subtext: TranslationHolder?) : ComponentStructure(x, y, width, height, subtext) {

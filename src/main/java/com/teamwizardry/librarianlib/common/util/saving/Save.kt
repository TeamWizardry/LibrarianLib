 ...
 *
 * [wailaName] is for WAILA auto-serialization. If [automaticallyAddFieldsToWaila] in the TE class is set to [false], this will have no effect.
 * If [wailaName] is set to an empty string, WAILA auto-serialization will be disabled for that field.
 */
@Target(FIELD)
@MustBeDocumented
annotation class Save(val saveName: String = "", val wailaName: String = "thisIsADefaultName")

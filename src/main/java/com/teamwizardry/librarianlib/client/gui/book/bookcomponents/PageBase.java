...
class PageBase extends GuiScreen {
    ...
    public static ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(LibrarianLib.MODID, "textures/bookcomponents/book/book.png");
    protected static int top, left, right;
    static boolean hasBookmark = false;
    static PageBase bookmarkedPage = null;
    protected String title = I18n.format("bookcomponents.physicsbook.defaulttitle");
    ...
    public void initGui() {
        ...
        buttonList.add(new Button(Const.ButtonID.BOOKMARK, 0, 0, 5, 5)); // bookmark button

        backButton = new Button(Const.ButtonID.NAV_BAR_BACK, 0, 0, 18, 10); // nav bar back button
        buttonList.add(backButton);
        nextButton = new Button(Const.ButtonID.NAV_BAR_NEXT, 0, 0, 18, 10); // nav bar next button
        buttonList.add(nextButton);
        returnButton = new Button(Const.ButtonID.NAV_BAR_INDEX, 0, 0, 17, 10); // nav bar index button

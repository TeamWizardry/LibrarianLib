...
public class Tippable extends PageBase {
    ...
    private static ResourceLocation SLIDERS = new ResourceLocation(LibrarianLib.MODID, "textures/bookcomponents/book/sliders.png");
    ...
    public static int setTip(String text, ItemStack recipeOutput, HashMap<SlotUtil, ItemStack> recipe) {
        if (text == null) text = "<ERROR>";
        ...
        for (int ID : tips.keySet()) {
            ...
            if (tip.hasRecipe()) {
                ...
                if (tip.isSlidingOut() && ID == IDs) {
                    ...
                    // render recipe item
                    for (SlotUtil slot : tip.getRecipe().keySet()) {

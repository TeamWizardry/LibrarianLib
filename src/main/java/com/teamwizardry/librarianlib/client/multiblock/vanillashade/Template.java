package com.teamwizardry.librarianlib.client.multiblock.vanillashade;
...
public class Template {
    ...
    /**
     * takes block from the world and puts the data them into this template
     */
                    ...
                    if ((block == null || block != block1) && (!p_189960_4_.getIgnoreStructureBlock() || block1 != Blocks.STRUCTURE_BLOCK) && (structureboundingbox == null || structureboundingbox.isVecInside(blockpos))) {
                        ...
                        if (p_189960_1_.setBlockState(blockpos, iblockstate1, p_189960_5_) && template$blockinfo1.tileentityData != null) {
                            ...
                            if (tileentity2 != null) {
                                ...
                                //tileentity2.func_189668_a(p_189960_4_.getMirror()); // mirror TE
                                //tileentity2.func_189667_a(p_189960_4_.getRotation()); // rotate TE
                            }
                        }
                    }
                }
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound p_189552_1_) {
        ...
        for (IBlockState iblockstate : template$basicpalette) {
            nbttaglist2.appendTag(NBTUtilTemplate.func_190009_a(new NBTTagCompound(), iblockstate));
        }

        p_189552_1_.setTag("palette", nbttaglist2);
        p_189552_1_.setTag("block", nbttaglist);
    ...
    public void read(NBTTagCompound compound) {
        ...
        for (int i = 0; i < nbttaglist1.tagCount(); ++i) {
            template$basicpalette.func_189956_a(NBTUtilTemplate.func_190008_d(nbttaglist1.getCompoundTagAt(i)), i);
        }

        NBTTagList nbttaglist3 = compound.getTagList("block", 10);

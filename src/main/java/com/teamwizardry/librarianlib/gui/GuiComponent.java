...
public abstract class GuiComponent<T extends GuiComponent<?>> implements IGuiDrawable {
	...
	public int zIndex = 0;
	protected Vec2d pos, size;
	
	public boolean mouseOverThisFrame = false;
	public Vec2d mousePosThisFrame = Vec2d.ZERO;
	 ...
	 */
	public abstract void drawComponent(Vec2d mousePos, float partialTicks);
	 ...
	 */
	public Vec2d rootPos(Vec2d pos) {
		if(parent == null)
	 ...
	 */
	public boolean isMouseOver(Vec2d mousePos) {
	 ...
	 * @param button
	 */
	public void mouseDrag(Vec2d mousePos, EnumMouseButton button) {
		if(!isVisible()) return;
	...
	public interface IComponentDrawEventHandler<T extends GuiComponent<?>> {
		void handle(T component, Vec2d mousePos, float partialTicks);
	}

	@FunctionalInterface
	public interface IComponentMouseEventHandler<T extends GuiComponent<?>> {
		boolean handle(T component, Vec2d pos, EnumMouseButton button);
	}

	@FunctionalInterface
	public interface IComponentMouseWheelEventHandler<T extends GuiComponent<?>> {
		boolean handle(T component, Vec2d pos, int direction);
	}
	...
	public interface IComponentCoordEventHandler<T extends GuiComponent<?>> {
		boolean handle(T component, Vec2d mousePos);
	}
	
	@FunctionalInterface
	public interface IComponentChildCoordTransformEventHandler<T extends GuiComponent<?>> {
		Vec2d handle(T component, GuiComponent<?> child, Vec2d mousePos);
	}

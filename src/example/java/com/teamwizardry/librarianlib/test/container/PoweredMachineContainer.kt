...
import com.teamwizardry.librarianlib.test.neogui.tests.GuiPoweredMachine
...
class PoweredMachineContainer(player: EntityPlayer, te: TEPoweredMachine) : ContainerBase(player) {
    ...
    companion object {
        ...
        init {
            GuiHandler.registerBasicNeoContainer(NAME, { player, _, tile -> PoweredMachineContainer(player, tile as TEPoweredMachine) }, { _, container -> GuiPoweredMachine(container) })
        }
    }
}
